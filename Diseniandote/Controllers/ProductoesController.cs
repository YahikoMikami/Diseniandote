...
namespace Diseniandote.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idProducto,nombre,descripcion,precioProduccion,precioVenta,estatus,idCategoria")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idProducto,nombre,descripcion,precioProduccion,precioVenta,estatus,idCategoria")] Producto producto)
        {
            if (ModelState.IsValid)
            {
