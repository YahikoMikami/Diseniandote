...
namespace Diseniandote.Controllers
{
    public class MedidasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idMedida,descripcion,estatus")] Medida medida)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idMedida,descripcion,estatus")] Medida medida)
        {
            if (ModelState.IsValid)
            {
