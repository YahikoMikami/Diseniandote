...
namespace Diseniandote.Controllers
{
    public class TipoUsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idTipoUsuario,descripcion,estatus")] TipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idTipoUsuario,descripcion,estatus")] TipoUsuario tipoUsuario)
        {
            if (ModelState.IsValid)
            {
